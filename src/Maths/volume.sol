...
contract Volume {
    ...
    function volCuboid(uint256 width, uint256 length, uint256 height)
        public
        pure
        returns (uint256)
    {
    ...
    function volPyramid(uint256 baseLength, uint256 baseWidth, uint256 height)
        public
        pure
        returns (uint256)
    {
        ...
        returns (uint256)
    {
        ...
        return (HALF_IN_WEI * baseLengthTriangle * heightTriangle * height) / 1e18;
    }
        ...
        returns (uint256)
    {
        ...
        return
            (
                FIVE_DIVIDEDBY_TWO_IN_WEI * pentagonalLength * pentagonalBaseLength * height
            )
            / 1e18;
    }
